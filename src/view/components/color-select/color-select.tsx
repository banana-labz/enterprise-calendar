...
import { ColorSelectLayout, SquareButton, ColorPicker } from "./color-select.styled"
...
export const ColorSelect = ({
  ...
  return (
    <ColorSelectLayout ref={colorSelectRef}>
      <SquareButton
        color={value}    
        onClick={handleSwitchColorPicker}
      />
      {isOpen && <ColorPicker disableAlpha color={value} onChangeComplete={onChangeHandler} />}
    </ColorSelectLayout>
  )
}